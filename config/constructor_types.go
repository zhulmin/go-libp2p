...
var (
	...
	addrConnGaterType = reflect.TypeOf((*connmgr.AddressConnectionGater)(nil))
...
var argTypes = map[reflect.Type]constructor{
	...
	addrConnGaterType: func(h host.Host, u *tptu.Upgrader) interface{} { return u.AddrConnGater },
