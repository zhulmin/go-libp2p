...
|     **Bytes Read (KiB)** |                    |                      |
|                      min |               0.000|                 0.000|
|                      max |            2590.000|              2601.000|
|                      avg |            2259.697|              2482.053|
|  **Bytes Written (KiB)** |                      |                    |
|                      min |               0.000|                 0.000|
|                      max |            2705.000|              2601.000|
|                      avg |              2482.053|            2290.186|
...
|     **Bytes Read (KiB)** |                      |                    |
|                      min |                 0.000|               0.000|
|                      max |              2595.000|            2593.000|
|                      avg |              2485.862|            2258.337|
|  **Bytes Written (KiB)** |                      |                    |
|                      min |                 0.000|               0.000|
|                      max |              2595.000|            2699.000|
|                      avg |              2485.862|            2288.732|
