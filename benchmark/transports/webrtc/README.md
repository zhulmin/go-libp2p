...
|     **Bytes Read (KiB)** |                      |                    |
|                      min |                 0.000|               0.000|
|                      max |            2040.000|              2046.000|
|                      avg |              1699.342|            1544.492|
|  **Bytes Written (KiB)** |                      |                    |
|                      min |                 0.000|               0.000|
|                      max |              2043.000|            2080.000|
|                      avg |              1699.342|            1552.577|
...
|     **Bytes Read (KiB)** |                    |                      |
|                      min |               0.000|                 0.000|
|                      max |            2590.000|              2591.000|
|                      avg |            1673.189|              2482.405|
|  **Bytes Written (KiB)** |                    |                      |
|                      min |               0.000|                 0.000|
|                      max |            2693.000|              2591.000|
|                      avg |              2482.405|            1684.701|
