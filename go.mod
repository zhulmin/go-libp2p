module github.com/libp2p/go-libp2p/v7
...
require (
	...
	github.com/libp2p/go-libp2p-autonat v0.0.0-20181221182007-93b1787f76de
	...
	github.com/libp2p/go-ws-transport v2.0.15+incompatible
